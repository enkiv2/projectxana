...
double logb(double x);	///
//float  logb(float x) { return cast(float) logb(cast(double)x); }
real   logb(real x) { return cast(real) logb(cast(double) x); }
...
/+
double fabs(double x);// { return cast(double) fabsf(cast(float) x); }
float fabsf(float x);// { return cast(float) fabsf(cast(double)x); }
real fabsl(real x) { return cast(real)fabs(cast(double)x); }
//real fabs(real x) { return fabsf(x); }
...
double sqrt(double x);	///
float  sqrt(float x);// { return cast(float) sqrt(cast(double)x); }
real   sqrtl(real x);// { return cast(real) sqrt(cast(double)x); }
...
float rint(float f) { return cast(float) rint(cast(double)f); }

int    lrint(double x);	///
int    lrintf(float x);	/// ditto
int    lrintl(real x);	/// ditto
//float lrint(float f) { return cast(float) lrint(cast(double) f); }

long   llrint(double x);	///
long   llrintf(float x);	/// ditto
long   llrintl(real x);		/// ditto
//float llrint (float f) { return cast(float) llrint(cast(double) f); }
